...
1. **Facing lethal** — If incoming damage will kill you and you can't block enough, use defensive potions (Block Potion, Fairy in a Bottle triggers automatically, etc.)
...
3. **Boss fights** — Potions are meant to be used. Don't hoard through a boss fight. Use offensive potions for damage and defensive potions for survival.
...
1. **Easy normal fights** — Regular hallway fights against weak enemies don't warrant potion use. Win with cards alone.

2. **Early in a fight** — Don't use potions on turn 1 of a long fight unless immediately threatened. Wait to see how the fight develops.

3. **Boss approaching** — If the map shows a boss fight coming soon, save potions for it.

4. **Potion belt has room** — No need to use a potion just because you have it. Save for harder fights.
...
- Energy Potion: Use BEFORE playing cards to maximize options. Don't waste on a turn where you'd end with leftover energy anyway.
